...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"K14E":[function(require,module,exports) {
...
},{"process":"K14E"}],"BMpT":[function(require,module,exports) {
"use strict";
...
function DateFormat(date) {
  ...
  var MM = parseInt(date.getMonth()) < 10 ? '0' + date.getMonth() : date.getMonth();
  var DD = parseInt(date.getDate()) < 10 ? '0' + date.getDate() : date.getDate();
  var hh = parseInt(date.getHours()) < 10 ? '0' + date.getHours() : date.getHours();
  var mm = parseInt(date.getMinutes()) < 10 ? '0' + date.getMinutes() : date.getMinutes();
  var ss = parseInt(date.getSeconds()) < 10 ? '0' + date.getSeconds() : date.getSeconds();
  return "".concat(YY, "-").concat(++MM, "-").concat(DD, " ").concat(hh, ":").concat(mm, ":").concat(ss);
}
},{}],"dR79":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PopToast = PopToast;
...
function PopToast(type, message) {
  var $message = (0, _jQuery.default)("<message class=\"message message-".concat(type, "\">\n      ").concat(icons[type], "\n      <span class=\"text\">").concat(message, "</span>\n    </message>"));
  (0, _jQuery.default)('.message-box').append($message);
  setTimeout(function () {
    (0, _jQuery.default)('.message-box').find('message:first').remove();
  }, 2500);
}
},{"jQuery":"BITX"}],"AB3p":[function(require,module,exports) {
...
module.exports = "pier.576d0f65.png";
},{}],"dCRy":[function(require,module,exports) {
module.exports = "Noon.a464d1be.png";
},{}],"DO8X":[function(require,module,exports) {
module.exports = "night.237d5bd5.png";
...
var _PopToast = require("../utils/PopToast");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// 获取 localStorage - siteList
var oldSitesCache = localStorage.getItem('sitesHashMapCache');
var sitesHashMapCache = JSON.parse(oldSitesCache);
var sitesHashMap = sitesHashMapCache || [{
  name: '南航',
...
var oldWishListCache = localStorage.getItem('wishListCache');
var wishListCache = JSON.parse(oldWishListCache);
var wishList = wishListCache || []; // 获取 localStorage - todList

var oldTodoListCache = localStorage.getItem('todoListCache');
var todoListCache = JSON.parse(oldTodoListCache);
var todoList = todoListCache || [];
var $naviPage = (0, _jQuery.default)('.navi-page'); // 导航页

var $indicatorUl = (0, _jQuery.default)('.indicator ul'); // 切换标识 ul

var $indicatorLis = $indicatorUl.find('li'); // 切换标识 ul > lis

var $todoButton = (0, _jQuery.default)('.todo'); // 获取代办 button

var $todoInput = (0, _jQuery.default)('.todo-input'); // 获取代办 input

var $todoListUl = (0, _jQuery.default)('.todo-list-ul'); // 获取 todoListUl

var $wishInput = (0, _jQuery.default)('.wish-input'); // 获取愿望 input

var $wishList = (0, _jQuery.default)('.wish-list'); // 获取愿望 list

var $wishListUl = (0, _jQuery.default)('.wish-list-ul'); // 获取愿望 listUl

var $wishButton = (0, _jQuery.default)('.wish-button'); // 获取愿望按钮

var $wishingTab = (0, _jQuery.default)('.wishing-tab'); // 获取

var $realizeTab = (0, _jQuery.default)('.realize-tab'); // 获取

var $tabBar = (0, _jQuery.default)('.tab-bar'); // 获取 tabBar 的按钮

var $search = (0, _jQuery.default)('.search'); // 获取 search 表单

var $input = (0, _jQuery.default)('.search input'); // 获取 search 表单的 input

var $addSiteLi = (0, _jQuery.default)('.add-site-li'); // 获取新增快捷方式按钮

var $siteModal = (0, _jQuery.default)('.site-modal'); // 获取 site 模态框

var $siteModalClose = (0, _jQuery.default)('.site-modal-close'); // 获取 site 模态框 close

var $newSiteName = (0, _jQuery.default)('.site-modal .name'); // 获取新增快捷方式的 name

var $newSiteLink = (0, _jQuery.default)('.site-modal .link'); // 获取新增快捷方式的 link

var $siteModalCancel = (0, _jQuery.default)('.site-modal .cancel'); // 获取新增快捷方式取消按钮

var $siteModalConfirm = (0, _jQuery.default)('.site-modal .confirm'); // 获取新增快捷方式确认按钮

var $audioWind = (0, _jQuery.default)("#audio-wind")[0]; // 获取 wind 音频元素

var $audioLove = (0, _jQuery.default)("#audio-love")[0]; // 获取 love 音频元素

var $windmill = (0, _jQuery.default)('.windmill'); // 获取底部的箭头
...
var documentScrollAuthority = true;
$wishListUl.on('mouseover', function () {
  documentScrollAuthority = false;
});
$wishListUl.on('mouseleave', function () {
  documentScrollAuthority = true;
}); // 添加代办事件

$todoButton.on('click', function (event) {
  event.stopPropagation();
  $todoInput.on('click', function (event) {
    event.stopPropagation();
  });
...
$todoInput.keydown(function (event) {
  if (event.code === 'Enter') {
    ...
    if (todoList.length >= 7) {
      (0, _PopToast.PopToast)('info', '事情总要一件一件的做嘛，小傻瓜 ~ 😉');
      return;
    }

    todoList.push({
      todoText: $todoInput.val(),
      createTime: (0, _DateFormat.DateFormat)(new Date())
    });
    $todoInput.val('');
    renderTodoList();
    (0, _PopToast.PopToast)('success', '事件添加成功，小傻瓜要加油啦 ~ 👻');
  }
}); // 删除代办事件 todoListItem

$todoListUl.on('click', 'svg', function (event) {
  var clickedTodoItemIndex = (0, _jQuery.default)(event.currentTarget.parentNode.parentNode).index();
  todoList.splice(clickedTodoItemIndex, 1);
  renderTodoList();
  (0, _PopToast.PopToast)('success', '真是个勤劳的小傻瓜，要劳逸结合哦 ~ 😘');
}); // 渲染 todoList
...
function renderTodoList() {
  ...
  todoList.forEach(function (item) {
    var $li = (0, _jQuery.default)("<li class=\"gauss\">\n                  <div class=\"text-time\">\n                    <div class=\"text\" title=\"".concat(item.todoText, "\">").concat(item.todoText, "</div>\n                    <div class=\"time\">").concat(item.createTime, "</div>\n                  </div>\n                  <div class=\"cheers\" title=\"\u5927\u529F\u544A\u6210\uFF0C\u5E72\u676F ~\">\n                    <svg class=\"icon\"><use xlink:href=\"#icon-jiubei\"></use></svg>\n                  </div>\n                 </li>"));
    $todoListUl.append($li);
  });
} // 初始化渲染 todoList


renderTodoList(); // 添加小愿望 - wishList

$wishButton.on('click', function (event) {
  event.stopPropagation();
  $wishInput.on('click', function (event) {
    event.stopPropagation();
  });
...
$wishInput.keydown(function (event) {
  if (event.code === 'Enter') {
    ...
    if (isRepeat) {
      (0, _PopToast.PopToast)('warning', '有啦有啦，这个小愿望已经有啦 ~ 😉');
    } else {
      wishList.push({
        wishText: $wishInput.val(),
        createTime: (0, _DateFormat.DateFormat)(new Date()),
        realize: 0
      });
      ...
      $wishInput.val('');
      renderWishList();
      (0, _PopToast.PopToast)('success', '添加成功，让我看看我家小傻瓜许的什么愿？ 🧐');
    }
  }
}); // 实现小愿望 wishListItem

$wishListUl.on('click', 'svg', function (event) {
  var clickedWishItemText = (0, _jQuery.default)(event.currentTarget.parentNode.parentNode)[0].innerText;
  var clickedWishItemIndex;
  ...
  (0, _PopToast.PopToast)('success', '哦吼吼，实现啦，愿望实现啦 ~ 😍');
}); // 切换愿望 tab - wishing/realize

$wishingTab.on('click', function () {
  $wishingTab.addClass('active').siblings().removeClass("active");
  renderWishList();
});
$realizeTab.on('click', function () {
  $realizeTab.addClass('active').siblings().removeClass("active");
  renderWishList('realize');
}); // 渲染 wishList

function renderWishList() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'wishing';
  $wishListUl.find('li').remove(); // 渲染前移除之前的 wishItem

  var filterWishList = [];
  filterWishList = state === 'wishing' ? wishList.filter(function (item) {
    return item.realize === 0;
  }) : wishList.filter(function (item) {
    return item.realize >= 1;
  });
  filterWishList.forEach(function (item) {
    var $li = (0, _jQuery.default)("<li class=\"gauss\">\n              <span class=\"text\" title=\"".concat(item.wishText, "\">").concat(item.wishText, "</span>\n              <div class=\"heart\" title=\"\u70B9\u51FB\u5C0F\u7EA2\u5FC3\u5C31\u8868\u793A\u613F\u671B\u5DF2\u7ECF\u5B9E\u73B0\u4E86\u54E6 ~\">\n                <svg class=\"icon\"><use xlink:href=\"#icon-aixin\"></use></svg>\n              </div>\n            </li>"));
    $wishListUl.append($li);
  });
} // 初始化渲染 wishList


renderWishList(); // 切换搜索网站 → tabBar 事件委托

$tabBar.on('click', "div", function (event) {
  var $tabItem = (0, _jQuery.default)(event.currentTarget); //获取当前被点击的元素
...
function renderSitesHashMap() {
  (0, _jQuery.default)('.site-list').find('li:not(.add-site-li)').remove(); // 渲染前移除添加按钮前的模块

  sitesHashMap.forEach(function (item, index) {
    // 根据sitesHashMap创建相应的元素并添加到新增按钮前
    var $li = (0, _jQuery.default)("<li class=\"block\">\n      <a href=\"".concat(item.url, "\">\n        <div class=\"logo\"><img src=").concat(item.logoPath, "></div>\n        <div class=\"site\">").concat(item.name, "</div>\n      </a>\n      <div class=\"close\">\xD7</div>\n    </li>\n    ")).insertBefore($addSiteLi);
    if (sitesHashMap.length >= 10) $addSiteLi.css('visibility', 'hidden');
    $li.on('click', '.close', function (event) {
      ...
      renderSitesHashMap();
      (0, _PopToast.PopToast)('success', '啊哦，快捷方式被删掉了哦 ~ 😮');
    });
  });
} // 初始化渲染 sitesHashMap


renderSitesHashMap(); // 点击添加快捷方式按钮，显示模态框

$addSiteLi.on('click', function () {
  $siteModal.addClass('show-site-modal');
}); // 添加相应的快捷方式 li 网址模块

$siteModalConfirm.on('click', function () {
  if ($newSiteName.val() && $newSiteLink.val()) {
    ...
    var path = iconArr["icon".concat(sitesHashMap.length + 1)]; // TODO 依然待优化
    ...
    if (sitesHashMap.length >= 10) {
      ...
      (0, _PopToast.PopToast)('info', '真是个贪心的小傻瓜呢~ 😏');
    }

    renderSitesHashMap();
    (0, _PopToast.PopToast)('success', '快捷方式添加成功，这下方便多了 ~ 😁');
  } else {
    (0, _PopToast.PopToast)('error', '调皮哦，不好好输入打你呦 ~ 🤨');
  }
}); // 点击 关闭/取消 关闭 site 模态框

$siteModalClose.on('click', function () {
  $siteModal.removeClass('show-site-modal');
});
$siteModalCancel.on('click', function () {
  $siteModal.removeClass('show-site-modal');
}); // 背景图片部分
...
$naviPage.css("backgroundImage", "url(".concat(wallpaperArray[wallpaperFlag].imagePath, ")")); // 点击风车 windmill 切换背景图片
...
$windmill.on('click', function () {
  ...
  $naviPage.css("backgroundImage", "url(".concat(wallpaperArray[wallpaperFlag].imagePath, ")"));
  (0, _PopToast.PopToast)('success', '快告诉我这张壁纸好不好看呀 ~ 😎');
...
$indicatorUl.on('click', function (event) {
  ...
  $naviPage.css('margin-top', "".concat(clickedIndex * -100, "vh"));

  if (clickedIndex === 2) {
    (0, _PopToast.PopToast)('warning', '前方高能预警，单身狗请迅速撤离！ 🤭');
    $audioLove.play();
  } else {
    $audioLove.pause();
  }
...
(0, _jQuery.default)(document).on("mousewheel DOMMouseScroll", function (event) {
  var delta = event.originalEvent.wheelDelta && (event.originalEvent.wheelDelta > 0 ? 1 : -1) || // chrome & ie
  event.originalEvent.detail && (event.originalEvent.detail > 0 ? -1 : 1); // firefox

  if (delta > 0 && documentScrollAuthority) {
    // 向上滚
    currentIndicator--;

    if (currentIndicator >= 0) {
      $naviPage.css('margin-top', "".concat(-currentIndicator * 100, "vh"));
  ...
  } else if (delta < 0 && documentScrollAuthority) {
    // 向下滚
    if (currentIndicator === 1) (0, _PopToast.PopToast)('warning', '前方高能预警，单身狗请迅速撤离！ 🤭');
    currentIndicator++;
...
window.onbeforeunload = function () {
  var newTodoListCache = JSON.stringify(todoList);
  localStorage.setItem('todoListCache', newTodoListCache);
  var newWishListCache = JSON.stringify(wishList);
  localStorage.setItem('wishListCache', newWishListCache);
  var newSitesHashMapCache = JSON.stringify(sitesHashMap);
...
},{"jQuery":"BITX","../utils/DateFormat":"BMpT","../utils/PopToast":"dR79","../assets/img/icon/icon1.png":"AB3p","../assets/img/icon/icon2.png":"GXZF","../assets/img/icon/icon3.png":"Skyo","../assets/img/icon/icon4.png":"sTvj","../assets/img/icon/icon5.png":"f9I4","../assets/img/icon/icon6.png":"TLFA","../assets/img/icon/icon7.png":"aS9c","../assets/img/icon/icon8.png":"EsZT","../assets/img/icon/icon9.png":"WTB7","../assets/img/icon/icon10.png":"jYai","../assets/img/wallpaper/yourname.jpg":"kAkt","../assets/img/wallpaper/lantern.jpg":"UonK","../assets/img/wallpaper/pier.png":"C48A","../assets/img/wallpaper/Noon.png":"dCRy","../assets/img/wallpaper/night.png":"DO8X","../assets/img/wallpaper/schoolGirl.png":"jYol"}]},{},["KDbR"], null)
//# sourceMappingURL=navi_page.6a944e8b.js.map